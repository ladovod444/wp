...
function ale_get_necessary_image_size(){
    ...
    if($ale_work_columns and $ale_work_layout){
        switch($ale_work_columns) {
            case '1' :
                $thumb_size = 'works-'.esc_attr($ale_work_layout).'extrabig';
                break;
            case '2' :
                $thumb_size = 'works-'.esc_attr($ale_work_layout).'big';
                break;
            case '3' :
                $thumb_size = 'works-'.esc_attr($ale_work_layout).'large';
                break;
            case '4' :
                $thumb_size = 'works-'.esc_attr($ale_work_layout).'medium';
                break;
            case '5' :
                $thumb_size = 'works-'.esc_attr($ale_work_layout).'small';
                break;
        }
    }
