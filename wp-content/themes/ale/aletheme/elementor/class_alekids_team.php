...
class Ale_Elementor_Widget_Alekids_Team extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		if ( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			wp_register_script( 'alekids-team', ALE_PLUGIN_URL. '/elementor/js/widget-alekids-team.js', [ 'elementor-frontend','jquery-slick' ], '1.0', true );
			return [ 'alekids-team' ];
		}
                            ...
                            <div class="line_content" <?php if(!empty($member['list_color'])){ echo 'style="background-color:'.esc_attr($member['list_color']).';"';} ?>>
								...
								<div class="team_social">
									...
									if(!empty($member['list_ins'])){
										echo '<a href="'.esc_url($member['list_ins']).'"><div class="alekids_round_icon"><div class="mask"></div><div class="icon">
									...
									if(!empty($member['list_twi'])){
										echo '<a href="'.esc_url($member['list_twi']).'"><div class="alekids_round_icon"><div class="mask"></div><div class="icon">
