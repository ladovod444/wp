...
class Ale_Elementor_Widget_Alekids_Timeline extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		if ( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			wp_register_script( 'alekids-timeline', ALE_PLUGIN_URL. '/elementor/js/widget-alekids-timeline.js', [ 'elementor-frontend','jquery-slick' ], '1.0', true );
			return [ 'alekids-timeline' ];
		}
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
	  ...
	  $widgets[ $this->get_name() ] = [
			...
			'fields' => [
                [
                        'field' => 'list_year',
                        'type' => $this->get_title() .'<br />'. esc_html__( "Year", "ale" ),
                        'editor_type' => 'LINE'
                ],
                [
                        'field' => 'list_title',
			...
			[
                ...
                'default' => [
					...
					[
						...
						'list_title' => esc_html__( 'EduBii certified partner', 'ale' ),
						'list_content' => esc_html__( 'Turpis eu sit metus, id sed id sit a aliquet. Habitant vestibulum pellentesque.', 'ale' ),
					],
				],
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="line_content">
                                ...
                                <?php if(!empty($line['list_title'])){ ?>
                                    <h4 class="alekids_title"><?php echo esc_html($line['list_title']); ?></h4>
                                <?php } ?>
