...
class Ale_Elementor_Widget_Alekids_Contact_Icon extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Icon', 'ale' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'icon_one',
				'options' => [
					'icon_one'  => esc_html__( 'Cup Icon', 'ale' ),
					'icon_two' => esc_html__( 'Map Icon', 'ale' ),
					'icon_three' => esc_html__( 'Phone  Icon', 'ale' ),
					'icon_four' => esc_html__( 'Email Icon', 'ale' ),
