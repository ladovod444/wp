	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
	  ...
	  $widgets[ $this->get_name() ] = [
			...
			'fields' => [
                [
                        'field' => 'title',
                        'type' => $this->get_title() .'<br />'. esc_html__( "Counter Title", "ale" ),
                        'editor_type' => 'LINE'
                ],
			],
	  ];
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'icon_one',
				'options' => [
					'one'  => esc_html__( 'Crown Icon', 'ale' ),
					'two' => esc_html__( 'Lawyer Icon', 'ale' ),
					'three' => esc_html__( 'Boy Icon', 'ale' ),
					'four' => esc_html__( 'Stat Icon', 'ale' ),
