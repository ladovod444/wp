...
class Ale_Elementor_Widget_Alekids_Socialbox extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Social Box', 'ale' );
	}
            ...
            <div class="social_content">
                <div class="image_holder">
                    <?php if($settings['image']['url']) { ?>
                        <img src="<?php echo esc_url($settings['image']['url']); ?>" alt="<?php echo esc_html($settings['title']); ?>" />
                    <?php } ?>
                </div>
                    ...
                    <?php if($settings['title']){ ?>
                        <h6>
                            <?php if(!empty($settings['link']['url'])){ ?>
                                <a href="<?php echo esc_url($settings['link']['url']); ?>" <?php echo (!empty($settings['link']['nofollow']) ? 'rel="nofollow"' : 'rel="follow"'); ?> <?php echo (!empty($settings['link']['is_external']) ? 'target="_blank"' : 'target="_self"'); ?>>
