...
if ( $product->is_in_stock() ) : ?>
            ...
            <div class="form_wrapper">
                ...
                <div class="alekids_button">
                    <div class="container">
                        ...
                        <span>
                            <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button font_one alt"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
                        </span>
                    </div>
                </div>
    ...
    <?php } else if(ale_get_option('woo_grid_style') == 'default' && ALETHEME_DESIGN_STYLE == 'pizza'){?>
        <form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
            <div class="line_single_shop">
                <?php 
                echo '<div class="product_price_box font_one">';
                    woocommerce_template_single_price();
                echo '</div>';
                do_action( 'woocommerce_before_add_to_cart_button' ); ?>
                <div class="single_product_price_data">
                    <?php
