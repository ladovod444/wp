...
<div class="title_background_container enforcement_heading">
    <div class="page_title_container <?php echo esc_attr($ale_bg_for_title_class); ?> cf"  data-scroll-speed="4" data-scroll-type="background" <?php if($ale_bg_for_title){ ?>style="background-image: url(<?php echo esc_url($ale_bg_for_title); ?>);"<?php } ?>>
        <div class="mask"></div>
        <div class="enforcement_page_title cf" >
            <?php if($ale_title_for_heading){ ?><h2><?php echo esc_html($ale_title_for_heading); ?></h2><?php } ?>
            <?php if($ale_pre_title_for_heading){ ?><span class="pretitle"><?php echo esc_html($ale_pre_title_for_heading); ?></span><?php } ?>
        </div>
    </div>
</div>