...
<article <?php post_class('grid-item'); ?> id="post-<?php the_ID()?>" data-post-id="<?php the_ID()?>">
        ...
        <div class="post_image_holder">
            ...
            <?php if($ale_date_position == 'onimage'){ ?>
                <div class="date_mask">
                    ...
                    <!--<span class="day"><?php echo esc_html(get_the_date('j')); ?></span><br />
    ...
    <div class="post_content_holder">
        ...
        <?php if(ale_get_option('blog_grid_layout') !== 'magazine'){ ?>
            <?php if(ale_get_option('custom_blog_excerpt_count') > 0){ ?>
            ...
            if(get_the_title() == false ){ ?>
                <a class="ale_button" href="<?php echo esc_url(the_permalink()); ?>"><?php esc_html_e('Read More','ale'); ?></a>
            <?php } ?>
        <?php } ?>
