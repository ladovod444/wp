 ...
 * @package   Alebooking
 * @author    DZ
 * @link      http://example.com/Alebooking
 * @copyright 2023
 * @license   GPL-2.0+
 */
 ...
 * @author  Gary Jones
 */
class Ale_Booking_Template_Loader extends Gamajo_Template_Loader {
	/**
	 ...
	 * @var string
	 */
	protected $filter_prefix = 'alebooking';
	 ...
	 * @var string
	 */
	protected $theme_template_directory = 'alebooking';
	 ...
	 * @var string
	 */
	protected $plugin_directory = ALEBOOKING_PLUGIN_DIR;
